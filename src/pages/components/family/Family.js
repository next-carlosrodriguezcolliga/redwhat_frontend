...
class Family extends React.Component {
  ...
  componentDidMount(){
    ...
    fetch('http://users-backend-native-redwhat.apps.cluster-3397.3397.example.opentlc.com/users/family/completed', requestOptions)
    ...
    return (
      <div className={s.root}>
        <h1 className="page-title">
          <span className="fw-semi-bold">Family</span> - World
        </h1>
        <h2>Economía familiar</h2>
        <div>
          <Row>
            <Col lg={7} xs={12}>
              <iframe width="800" height="450" src="https://www.powtoon.com/embed/fDJ3wcErWF5/" frameborder="0" allowfullscreen></iframe>
            </Col>     
